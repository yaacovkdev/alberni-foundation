    ...
    return (
        <div className="foundation">
            <div className="foundation__text">
                <h2 className="foundation-title header-font-size">The Alberni Valley Community Foundation</h2>
                <p className="foundation-description normal-sans-font-size sans-font">Our Foundation is registered with the Canada Customs and Revenue Agency.
            ...
            <div className="foundation__bar">
                <h3 className="foundation-header subheader-font-size">Latest Announcements</h3>
