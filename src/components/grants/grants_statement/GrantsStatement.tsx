import "./GrantsStatement.css";

export default function GrantsStatement() {
  return (
    <section className="grants-statement">
      <div className="grants-statement__text">
        <p className="normal-sans-font-size sans-font">
          ...
          February 28th. Qualifying charities will be notified should the
          Foundation require further information regarding their application.
        </p>
      </div>
    </section>
  );
